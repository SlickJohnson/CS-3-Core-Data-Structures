...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('red', 'ed') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('huh', 'buh') is False  # last 2 letters, but not first.
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('blah blah blah', 'blah') is True  # whitespace
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        assert find_index('baba', 'ba') == 0  # multiple occurrences
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('yoh', 'hoy') is None  # reverse order.
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('aaabaaabaaab', 'aaaba') == [0, 4]  # overlapping pattern
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('HAHAHAHAHA', 'uh?') == []  # overlapping pattern
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('how now brown cow?', 'ow') == [1, 5, 10, 15]  # multiple occurrences
